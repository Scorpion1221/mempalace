...
def _get_collection(create=False):
    ...
    try:
        ...
        # Must call _get_client() BEFORE computing needs_rebuild — it can reset
        # _collection_cache to None on inode/mtime change (DB reconnect), and we
        # need to see that reset here.
        client = _get_client()
